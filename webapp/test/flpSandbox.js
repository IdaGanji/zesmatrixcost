		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Escalation Matrix - By Cost Object",
									"targetURL": "#zescmatrizcost-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zescmatrizcost-display": {
								"semanticObject": "zescmatrizcost",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zescmatrizcost",
									"url": sap.ui.require.toUrl("zescmatrizcost")
								}
							}
						}
					}
